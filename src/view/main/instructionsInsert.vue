                        ...
                        <el-row :span="12" style="margin-top:50px;">
                            <el-form-item label="内容">
                                <div class="edit_container" >
                                    <quill-editor v-model="formData.content" ref="myQuillEditor" class="editer" :options="editorOption" @ready="contentReady($event)" style="height:300px;">
                                    </quill-editor>
                                </div>
                            </el-form-item>
                        </el-row>
...
export default {
  ...
  data() {
    return {
      editorOption: {},
      brs: [{ name: "新增使用说明", to: { name: "instructionsInsert" } }],
      formData: {
        content: null,
      },
      rules: {},
