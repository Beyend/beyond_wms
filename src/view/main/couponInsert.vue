                    ...
                    <el-col>
                        ...
                        <el-row :span="7">
                         ...
                         <el-dialog  title="添加商品类别"  style="width:50%;margin-left:500px;" :visible.sync="dialogTableVisibleGoodsType">
                                ...
                                <el-table :data="tableDataGoodsType" border style="width:500px;" height="200" @selection-change="handleSelectionChangeGoodsType">
                         ...
                         <el-dialog  title="添加商品"  style="width:60%;margin-left:450px;" :visible.sync="dialogTableVisibleGoods">
                                <span>
                                    <el-form :inline="true" :model="queryMap" ref="queryMap"  class="demo-form-inline"  >
                                        <el-col>
                                            <el-row>
...
export default {
  ...
  data() {
    return {
      startTimeNull: null,
      endTimeNull: null,
      brs: [{ name: "添加优惠券", to: { name: "couponInsert" } }],
      formData: {
        name: null,
        type: "满减券",
        mininumConsume: null,
