                    ...
                    <el-col >
                        ...
                        <!-- <el-row :span="12">
                            <el-form-item label="金币赠送">
                                ...
                                <div style="font-size:10px;color:#636c72;"> -->
                                        <!-- 会员购物赠送的金币, 如果不填写或填写0，则默认为不赠送金币<br/> 放开这个-->
                                        <!-- ，如果带%则为按成交价格的比例计算金币  -->
                                        <!-- 如: 购买2件，设置10 金币, 不管成交价格是多少， 则购买后获得20金币 <br/> 放开这个-->
                                        <!-- 如: 购买2件，设置10%金币, 成交价格2 * 200= 400， 则购买后获得 40 金币（400*10%）<br/> -->
                                <!-- </div>
                            </el-form-item>
                        </el-row> -->
                        <el-row :span="12">
                            <el-form-item label="丫丫币抵扣">
                                <div >
        ...
        if (valid) {
          ...
          this.$post("goodsSave", this.formData)
            .then(res => {
              ...
              loadingInstance.close();
                this.$to({ name: "goodsManager" ,query:{pageNo:this.pageNo}});
            })
            .catch(() => {
              loadingInstance.close();
            });
